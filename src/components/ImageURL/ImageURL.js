    ...
    <div className="ImageURL">
    	<div>
    		<div className="form__group field">
			  	<input type="url" className="form__field" placeholder="Name" name="name" id='name' required onChange={OnInputChange} />
			  	<label for="name" className="form__label">Enter Image URL</label>
			</div>
		</div>
		<br/>
		<div>
